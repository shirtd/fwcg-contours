...
DATASETS = {'rainier' : {   'labels' :  ['A', 'B', 'C', 'D', 'E'],
                            'colors' :  ['blue', 'green', 'yellow', 'salmon', 'purple'],
                            'cuts' :    [0.0, 0.15, 0.28, 0.38, 0.48, 1.0],
                            'views' :   {   'rainier' : {   'default'   : 'side',
                                                            'side'      : { 'view' : (29.71, 70.6, 10.7, np.array([ 0., -0.011,  0.386])), 'zoom' : 4.6, 'roll' : -101.887, 'parallel_projection' : False},
                                                            'top'       : { 'view' : (0.0, 0.0, 6., np.array([0. , 0. , 0.5])), 'zoom' : 2.6, 'roll' : -90, 'parallel_projection' : True}},
                                            'seattle' : {  'default'   : 'side',
                                                            'side'      : { 'view' : (39.73, 71.69, 25.91457, np.array([-0.3924,  0.4974,  0.4513])), 'zoom' : 4.6, 'roll' : -100, 'parallel_projection' : False},
                                                            'top'       : { 'view' : (0.0, 0.0, 6., np.array([0. , 0. , 0.5])), 'zoom' : 6.43, 'roll' : -90, 'parallel_projection' : True}},
                                            'cascades' : {  'default'   : 'side',
                                                            'side'      : { 'view' : (39.73, 71.69, 17.7, np.array([ 0.   , 0,  0.5])), 'zoom' : 4.6, 'roll' : -100, 'parallel_projection' : False},
                                                            'top'       : { 'view' : (0.0, 0.0, 6., np.array([0. , 0. , 0.5])), 'zoom' : 4.4, 'roll' : -90, 'parallel_projection' : True}}}},
            'surf' : {  'labels' : ['A', 'B', 'C', 'D', 'E'],
